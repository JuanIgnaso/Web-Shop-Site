            ...
            <div class="border-b border-gray-900/10 pb-12">
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <div class="sm:col-span-3">
                        <x-form.inputfield :params="['type'=>'text','name'=>'nombre_categoria','label'=>'Nombre de la Categoría','value'=>old('nombre_categoria',$categoria->nombre_categoria)]"></x-form.inputfield>
                    </div>
