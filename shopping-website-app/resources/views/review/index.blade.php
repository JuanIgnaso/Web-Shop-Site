                ...
                <section x-data="{ show: false,open: 'v',closed: '>' }" class="mb-4">
                    ...
                    @csrf
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mb-4">
                            ...
                            {{-- <div>
                                <x-form.select :label="'Usuario'" :name="'usuario'" :multiple="true" :show="'name'" :values="''"></x-form.select>
                            </div> --}}
                        ...
                        @foreach ($reviews as $review)
                                <tr  class="table-row">
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <i class="fa-solid fa-thumbs-up text-xl text-green-400"></i>
                                        @else
                                        <i class="fa-solid fa-thumbs-down text-xl text-red-400"></i>
                                        @endif
                                    </td>
