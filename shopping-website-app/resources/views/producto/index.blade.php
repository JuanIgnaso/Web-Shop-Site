...
<x-adminPanel.admin-panel-layout>
    ...
    <div class="mb-16">
        <div class="w-[90%] lg:w-[80%] m-auto relative overflow-x-auto mt-4 sm:rounded-lg">
            ...
            <button type="button" class="text-white bg-azulDianne hover:bg-neonNaranja  focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2  focus:outline-none "><a href="{{route('producto.create')}}">Añadir nuevo</a></button>
