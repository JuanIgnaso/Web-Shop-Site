...
<div class="min-h-screen pb-6 bg-linen">
    ...
    <h1 class="pb-3 text-5xl border-b-2 text-eternity"  id="open"> {{ $data['titulo']}}</h1>
        ...
        <div class="flex items-center justify-start mt-3 mb-6">
          ...
          <div x-data="{id: 1}">
            <button type="button" " @click="$dispatch('open-dropdown',{id})" class="text-white bg-coldPurple hover:bg-eternity transition duration-150 focus:ring-0  font-medium rounded-lg text-sm px-5 py-2.5 me-2   focus:outline-none ">Filtrar</button>
