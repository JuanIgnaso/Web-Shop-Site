@session('message')
<div class="p-4 mb-4 w-full m-auto text-sm mt-4 text-green-800 rounded-lg bg-green-100 " role="alert">
...
@session('warning')
<div class="p-4 mb-4 w-full m-auto text-sm mt-4 text-yellow-600 rounded-lg bg-yellow-100 " role="alert">
