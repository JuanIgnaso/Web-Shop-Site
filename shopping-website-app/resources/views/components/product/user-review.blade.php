    ...
    <article>
        <div class="flex items-center mb-4">
            ...
            <div class="font-medium ">
                <p>Nombre del Usuario <time datetime="2014-08-16 19:00" class="block text-sm text-gray-500 ">Usuario desde "fecha de registro"</time></p>
            </div>
        </div>
        <div class="flex items-center mb-1 space-x-1 rtl:space-x-reverse">
            ...
            {{-- -- --}}
            <h3 class="ms-2 text-sm font-semibold text-gray-900 ">Cabecera de la review!</h3>
        </div>
        <footer class="mb-5 text-sm text-gray-500 "><p>Opinión hecha en <time datetime="2017-03-03 19:00">March 3, 2017</time></p></footer>
