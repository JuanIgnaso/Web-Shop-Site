...
function loadProduct(target,element){
    target.innerHTML +=
    `
    <div class="id${element.producto.id} cart-element p-2 flex bg-white hover:bg-gray-100 cursor-pointer border-b border-gray-100" style="">
